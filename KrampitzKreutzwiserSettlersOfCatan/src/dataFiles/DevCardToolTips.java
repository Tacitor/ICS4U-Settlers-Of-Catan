...
public class DevCardToolTips {
    ...
    private final static String ROAD_TIP = "Road Building Card: Use this card to build two new roads for free. Regular rules still apply, only build cost is ommited.";
    private final static String MONOPOLY_TIP = "Monopoly Card: Use this card to select one resource type. You will then recieve all the cards of the type from all players.";
    private final static String YOP_TIP = "Year of Pleanty Card: Use this card to select one resource type. You will then recieve two of the recouse type.";
